      ...
      vm: {
        ...
        overallUtilizationCPU: {
          ...
          alert: {
            ...
            message: 'VM {{ $labels.nodename }}: High CPU Overall Utilization {{ $value }}%',
            expr: expr % { job: 'job=~"%s"' },
            linkGetParams: 'var-instance={{ $labels.nodename }}',
            customLables: vmCustomLables,
            thresholds: thresholds,
        ...
        overallUtilizationRAM: {
          ...
          alert: {
            ...
            message: 'VM {{ $labels.nodename }}: High RAM Overall Utilization {{ $value }}%',
            expr: expr % { job: 'job=~"%s"' },
            linkGetParams: 'var-instance={{ $labels.nodename }}',
            customLables: vmCustomLables,
            thresholds: thresholds,
        ...
        overallUtilizationDisk: {
          ...
          alert: {
            ...
            message: 'VM {{ $labels.nodename }}: High Disk Overall Utilization {{ $value }}%',
            expr: expr % { job: 'job=~"%s"' },
            linkGetParams: 'var-instance={{ $labels.nodename }}',
            customLables: vmCustomLables,
            thresholds: thresholds,
        ...
        overallNetworkErrors: {
          ...
          alert: {
            ...
            message: 'VM {{ $labels.nodename }}: High Overall Network Errors Count {{ $value }}%',
            expr: expr % { job: 'job=~"%s"' },
            linkGetParams: 'var-instance={{ $labels.nodename }}',
            customLables: vmCustomLables,
            thresholds: thresholds,
