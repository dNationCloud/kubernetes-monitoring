  ...
  defaultTemplate:: {
      ...
      k8s: {
        ...
        mostUtilizedPVC: {
          ...
          alert: {
            ...
            linkGetParams: 'var-pvc={{ $labels.persistentvolumeclaim }}&var-cluster={{ $externalLabels.cluster }}',
            thresholds: thresholds,
          },
        },
        apiServerHealth: {
        ...
        mostUtilizedMasterNodeCPU: {
          ...
          alert: {
            ...
            linkGetParams: 'var-instance={{ $labels.nodename }}&var-cluster={{ $externalLabels.cluster }}',
            thresholds: thresholds,
          },
        },
    ...
    L2: {
        ...
        pvcOverviewTable: {
          ...
          panel: {
            ...
            styles: [
              ...
              { alias: 'PVC', pattern: 'persistentvolumeclaim', link: true, linkTooltip: 'Detail', linkUrl: '/d/%s?var-namespace=${__data.fields["Namespace"]}&var-pvc=${__value.raw}&%s' % [$.defaultConfig.grafanaDashboards.ids.persistentVolumes, $.defaultConfig.grafanaDashboards.dataLinkCommonArgs] },
        ...
        nodeOverviewTable: {
          ...
          panel: {
            ...
            styles: [
              ...
              { alias: 'Node', pattern: 'node', link: true, linkTooltip: 'Detail', linkUrl: '/d/%s?var-view=pod&var-instance=${__value.raw}&%s' % [$.defaultConfig.grafanaDashboards.ids.containerDetail, $.defaultConfig.grafanaDashboards.dataLinkCommonArgs] },
            ],
            transformations: [
              { id: 'merge', options: {} },
              {
        ...
        statefulSetOverviewTable: {
          ...
          panel: {
            ...
            styles: [
              ...
              { alias: 'StatefulSet', pattern: 'statefulset', link: true, linkTooltip: 'Detail', linkUrl: '/d/%s?var-namespace=${__data.fields["Namespace"]}&var-statefulset=${__value.raw}&%s' % [$.defaultConfig.grafanaDashboards.ids.statefulSet, $.defaultConfig.grafanaDashboards.dataLinkCommonArgs] },
              { alias: 'Namespace', pattern: 'namespace', link: true, linkTooltip: 'Detail', linkUrl: '/d/%s?var-namespace=${__value.raw}&var-pod=All&var-view=pod&var-search=&%s' % [$.defaultConfig.grafanaDashboards.ids.containerDetail, $.defaultConfig.grafanaDashboards.dataLinkCommonArgs] },
            ],
            transformations: [
              { id: 'merge', options: {} },
              {
        ...
        podOverviewTable: {
          ...
          panel: {
            ...
            styles: [
              ...
              { alias: 'Namespace', pattern: 'namespace', type: 'string' },
              { alias: 'Pod', pattern: 'pod', link: true, linkTooltip: 'Detail', linkUrl: '/d/%s?var-container=All&var-view=pod&var-namespace=${__data.fields["Namespace"]}&var-pod=${__value.raw}&var-search=&%s' % [$.defaultConfig.grafanaDashboards.ids.containerDetail, $.defaultConfig.grafanaDashboards.dataLinkCommonArgs] },
            ],
            expr: [
              |||
        ...
        containerOverviewTable: {
          ...
          panel: {
            ...
            styles: [
              ...
              { alias: 'Container', pattern: 'container', link: true, linkTooltip: 'Detail', linkUrl: '/d/%s?var-container=${__value.raw}&var-namespace=${__data.fields["Namespace"]}&var-pod=${__data.fields["Pod"]}&var-view=container&var-search=&%s' % [$.defaultConfig.grafanaDashboards.ids.containerDetail, $.defaultConfig.grafanaDashboards.dataLinkCommonArgs] },
              { alias: 'Namespace', pattern: 'namespace', type: 'string' },
        ...
        jobOverviewTable: {
          ...
          panel: {
            ...
            styles: [
              ...
              { alias: 'Namespace', pattern: 'namespace', link: true, linkTooltip: 'Detail', linkUrl: '/d/%s?var-namespace=${__value.raw}&var-container=All&var-view=container&var-search=&%s' % [$.defaultConfig.grafanaDashboards.ids.containerDetail, $.defaultConfig.grafanaDashboards.dataLinkCommonArgs] },
            ],
            transformations: [
              {
                id: 'organize',
      ...
      vm: {
        ...
        overallUtilizationCPU: {
          local expr = 'round((1 - (avg(irate(node_cpu_seconds_total{%(job)s, mode="idle"}[5m]) * on(instance, cluster) group_left(nodename) (node_uname_info)) by (job, nodename) )) * 100)',
          local thresholds = defaultTemplate.commonThresholds.node,
          linkTo: [$.defaultConfig.grafanaDashboards.ids.nodeExporter],
          panel: {
            title: 'Overall Utilization',
        ...
        overallUtilizationRAM: {
          local expr = 'round((1 - sum by (job, nodename, cluster) (node_memory_MemAvailable_bytes{%(job)s} * on(instance, cluster) group_left(nodename) (node_uname_info)) / sum by (job, nodename, cluster) (node_memory_MemTotal_bytes{%(job)s} * on(instance, cluster) group_left(nodename) (node_uname_info))) * 100)',
          local thresholds = defaultTemplate.commonThresholds.node,
          linkTo: [$.defaultConfig.grafanaDashboards.ids.nodeExporter],
          panel: {
            title: 'Overall Utilization',
